...
public class myDbAdapter {
    ...
    public  int Cusmedelete(String uname)
    {
        SQLiteDatabase db = myhelper.getWritableDatabase();
    ...
    static class myDbHelper Cusmeextends SQLiteOpenHelper
    {
        ...
        public void CusmeonCreate(SQLiteDatabase db) {
        ...
        @Override
        public void CusmeonUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            try {
